const PAGE_TRANSLATIONS = {
    index: {
        fr: {
            ...
            aboutText: "Salut! je suis Dr.Taiko, et voici mon site web ! Comme vous pouvez le voir, j'ai pas encore grand chose dessus pour l'instant, mais j'y travaille, promis !",
